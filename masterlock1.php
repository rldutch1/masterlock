...
<body>
<b>Spin-Dial Masterlock Combination Assistant</b><br />This page will narrow your choices down to 100 possible combinations if you only know the <b><u>First</u></b> number of the combination.
...
echo "<br /><h2>All possible combinations with " . $firstnumber . " as the first number.</h2>";
...
//Second number.
if ($firstnumber_remainder === 0){ //If the remainder is zero, start at 2 and add 4 until you get to 39.
	$second = range(2,39,4);
	}
else if ($firstnumber_remainder === 1){ //If the remainder is one, start at 3 and add 4 until you get to 39.
	$second = range(3,39,4);
	}
else if ($firstnumber_remainder === 2){ //If the remainder is two, start at 0 and add 4 until you get to 39.
	$second = range(0,39,4);
	}
else if ($firstnumber_remainder === 3){ //If the remainder is three, start at 1 and add 4 until you get to 39.
	$second = range(1,39,4);
	}
